...
- Clone this repo:
```
git clone https://github.com/Spark-X-Cloud/python-aria-mirror-bot mirror-bot/
cd mirror-bot
```
...
- **INDEX_URL** : (Optional field) Refer to https://github.com/Spark-X-Cloud/Sparkxcloud-index/ The URL should not have any trailing '/'
